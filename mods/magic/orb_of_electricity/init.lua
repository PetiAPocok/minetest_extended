    ...
    on_use = function(itemstack, player, pointed_thing)
        ...
        if players_mana > 10 then
            ...
            obj = minetest.add_entity({
                ...
                y = player_pos.y + 1.5,
                z = player_pos.z
            }, "orb_of_electricity:lightning_ball")
...
minetest.register_entity("orb_of_electricity:lightning_ball", {
    physical = false,
    visual = "sprite",
    visual_size = {x=0.5, y=0.5},
    textures = {"orb_of_electricity_lightning_ball.png"},
        ...
        if self.timer > 0.2 then
            ...
            for k, obj in pairs(objs) do
                if obj:get_luaentity() ~= nil then
                    if obj:get_luaentity().name ~= "orb_of_electricity:lightning_ball" and obj:get_luaentity().name ~= "__builtin:item" then
