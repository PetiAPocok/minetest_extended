...
meseconify_door("doors:door_acacia_1")
meseconify_door("doors:door_acacia_2")
meseconify_door("doors:door_acacia_3")
meseconify_door("doors:door_acacia_4")
meseconify_door("doors:door_aspen_1")
meseconify_door("doors:door_aspen_2")
meseconify_door("doors:door_aspen_3")
meseconify_door("doors:door_aspen_4")
meseconify_door("doors:door_aspen_5")
meseconify_door("doors:door_aspen_6")
meseconify_door("doors:door_aspen_7")
meseconify_door("doors:door_jungle_1")
meseconify_door("doors:door_jungle_2")
meseconify_door("doors:door_jungle_3")
meseconify_door("doors:door_jungle_4")
meseconify_door("doors:door_jungle_5")
meseconify_door("doors:door_jungle_6")
meseconify_door("doors:door_pine")
